...
kmi = km.keymap_items.new('mesh.knife_tool', 'LEFT_BRACKET', 'PRESS')
...
kmi_props_setattr(kmi.properties, 'mode', 'EDIT')
kmi = km.keymap_items.new('object.mode_set', 'I', 'PRESS')
kmi_props_setattr(kmi.properties, 'mode', 'EDIT')
...
kmi_props_setattr(kmi.properties, 'extend', True)
kmi = km.keymap_items.new('object.mode_set', 'SPACE', 'PRESS')
kmi.active = False
